...
const EnterpriseWork = () => {
    ...
    return (
        <section id="enterprise-ai" className="relative px-6 md:px-12 py-24 border-b border-white/10 bg-obsidian-950 text-slate-300">
            <div className="max-w-7xl mx-auto">
                <SectionHeader
                    label="Intelligent Architectures"
                    title="AI"
                    accent="Systems"
                />
                    ...
                    {enterpriseProjects.map((project, idx) => (
                        ...
                        >
                            <div className="lg:col-span-4">
                                <h3 className="text-2xl md:text-3xl font-bold uppercase tracking-tight mb-4 text-white">
                                    {project.title}
                                </h3>
                            ...
                            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="p-8 border border-white/5 bg-obsidian-900">
                                ...
                                <div className="md:col-span-2 p-8 border border-signal-orange/20 bg-signal-orange/5">
